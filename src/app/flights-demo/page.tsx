    ...
    <div className="p-8 w-full max-w-7xl">
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <input 
              type="text" 
              placeholder="Search..." 
              className="pl-10 pr-4 py-2 rounded-full border border-[var(--border)] bg-[var(--card)] text-[var(--foreground)] text-sm focus:outline-none focus:ring-2 focus:ring-[var(--ring)]"
            />
          ...
          <button className="w-10 h-10 rounded-full bg-[var(--card)] border border-[var(--border)] flex items-center justify-center text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
        ...
        <div className="lg:col-span-8 -ml-8 pl-8 relative z-0">
           ...
           <div className="h-[400px] w-full [&>div]:rounded-l-none [&>div]:border-l-0 shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.05)] rounded-r-3xl bg-[var(--card)]">
             <LastTrips />
           </div>
        </div>
