    ...
    <div className="p-8 w-full max-w-7xl">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Detailed overview of your flights</p>
        </div>
        <div className="flex items-center gap-4">
          <div className="relative">
            <input 
              type="text" 
              placeholder="Search..." 
              className="pl-10 pr-4 py-2 rounded-full border border-slate-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#00BFA6]"
            />
          ...
          <button className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-slate-800 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-8">
        ...
        <div className="lg:col-span-8 -ml-8 pl-8 relative z-0">
           ...
           <div className="h-[400px] w-full [&>div]:rounded-l-none [&>div]:border-l-0 shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.05)] rounded-r-3xl bg-white">
             <LastTrips />
           </div>
        </div>
