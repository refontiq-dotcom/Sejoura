  ...
  return <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10"><div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
      ...
      <div className="px-6 sm:px-10 py-8 space-y-7 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
        ...
        <section><h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Informations administratives à compléter</h2><p>La forme juridique, le numéro RCCM, le NCC/compte contribuable, l'adresse professionnelle et l'e-mail officiel ne sont pas publiés ici car ils n'ont pas été confirmés. <strong>Aucun numéro ni adresse n'est inventé.</strong> Ces éléments devront être ajoutés avant une commercialisation nécessitant des mentions légales complètes.</p></section>
        ...
        <section><h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Contact</h2><p>Questions juridiques, contractuelles ou relatives aux données : <strong>+225 01 00 37 29 00</strong>.</p></section>
