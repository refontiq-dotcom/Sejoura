    ...
    <div className="space-y-6 p-4 md:p-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-[var(--primary-color,#0C1C33)] flex items-center justify-center">
            <Megaphone className="w-5 h-5 text-white" />
          </div>
          <div>
            <h1 className="text-xl font-bold text-slate-900 dark:text-white">Publicités Trouvetou</h1>
            <p className="text-sm text-slate-500">Créez une campagne, réglez via Wave, puis la diffusion démarre après confirmation.</p>
          </div>
        </div>
        <Button
          onClick={() => {
